...
public class RobotContainer implements Sendable {
 ...
 // boolean m_testModuleState = false;
  ...
  private void configureButtonBindings() {
    bButton.whileHeld(autoChargeLevel);
  ...
  public Command getAutonomousCommand() {
      ...
      Pose2d aprilPose = hashTag.getCurrentTag(2).getPose();
      ...
      // m_robotDrive.thetaController.reset(-m_robotDrive.getPose().getRotation().getRadians());
      ...
      autonomous autonomous = new autonomous(swerveControllerCommand, swerveControllerCommand2); 
      return autonomous;
  }

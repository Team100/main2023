...
public class HolonomicDriveController2 {
  ...
  public ChassisSpeeds calculate(
    ...
    System.out.println("Theta Feed Forward " + thetaFF);
    m_poseError = trajectoryPose.relativeTo(currentPose);
    m_rotationError = desiredHeading.minus(currentPose.getRotation());
    
    
    System.out.println("Measurment " + currentPose.getRotation().getRadians());
    System.out.println("Goal " + desiredHeading.getRadians());
    System.out.println("Goal - Measurment " + (desiredHeading.getRadians() - currentPose.getRotation().getRadians()));
    System.out.println("Error " + m_rotationError);

...
public class FancyTrajectoryTest {
    ...
    void testLikeAuton() {
        ...
        // commenting it out.
        // ChassisSpeeds output = mMotionPlanner.update(fpgatime, actualPose);
        ...
        // mMotionPlanner.getPathSetpoint();
        // TimedState<Rotation2d> heading_setpoint =
        // mMotionPlanner.getHeadingSetpoint();

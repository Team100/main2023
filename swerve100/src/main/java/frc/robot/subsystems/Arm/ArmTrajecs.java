...
public class ArmTrajecs {
    ...
    public static Trajectory getTrajectory(Supplier<Double>getUpperArm, Supplier<Double>getLowerArm,  ArmPosition position, ArmController m_arm, TrajectoryConfig trajecConfig){

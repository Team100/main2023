...
public class PIDController100 implements Sendable, AutoCloseable {
   ...
   */
  public PIDController100(double kp, double ki, double kd) {
    this(kp, ki, kd, 0.02);
  }
   ...
   */
  public PIDController100(double kp, double ki, double kd, double period) {
    m_kp = kp;
    m_ki = ki;
    m_kd = kd;

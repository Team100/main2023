...
public class LQRManager {
    ...
    public LQRManager(LQRGains g){
        this(g.maxV, g.maxA, g.plant, g.eX, g.eV, g.mX, g.Q1, g.Q2, g.R, g.maxVolts, g.seconds);
    }
    ...
    public LQRManager(double maxV, double maxA, LinearSystem<N2, N1, N1> plant, double eX, double eV, double mX, double Q1, double Q2, double R, double maxVolts, double seconds) {
        m_seconds = seconds;
        m_maxVolts = maxVolts;
    ...
    public void setLQR(LQRGains g) {
        this.set(g.maxV, g.maxA, g.plant, g.eX, g.eV, g.mX, g.Q1, g.Q2, g.R);
    }

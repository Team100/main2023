...
public class Autonomous extends SequentialCommandGroup {
    ...
    public Autonomous(SwerveDriveSubsystem m_robotDrive, ArmController m_arm, Manipulator m_manipulator,
            AHRSClass m_gyro, int routine, boolean isBlueAlliance) {
        if (routine == 2) {
            addCommands(
                    new SetCubeMode(m_arm, m_robotDrive),
                    new ParallelDeadlineGroup(new WaitCommand(armExtendDelay),
                    ...
                    new ParallelDeadlineGroup(new WaitCommand(armSafeDelay),

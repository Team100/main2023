...
public class DrivePositional extends CommandBase {
    ...
    public DrivePositional(SwerveDriveSubsystem robotDrive, DoubleSupplier x, DoubleSupplier y, Supplier<Rotation2d> rot) {
